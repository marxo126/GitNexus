...
export const STATE_SLOT_SEED_DATA: string[] = [
  ...
  `CREATE (ss:StateSlot {id: 'StateSlot:react-query:vendor-patterns-slug', name: '["vendor-patterns", slug]', filePath: 'hooks/useVendorPatterns.ts', startLine: 1, slotKind: 'react-query', cacheKey: '["vendor-patterns", slug]'})`,
  // Clean slot: single SWR hook, no conflict
  `CREATE (ss:StateSlot {id: 'StateSlot:swr:vendor-stats-slug', name: '["vendor-stats", slug]', filePath: 'hooks/useVendorStats.ts', startLine: 1, slotKind: 'swr', cacheKey: '["vendor-stats", slug]'})`,
