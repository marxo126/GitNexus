...
export const STATE_SLOT_SEED_DATA: string[] = [
  ...
  `CREATE (ss:StateSlot {id: 'StateSlot:react-query:vendor-patterns-slug', name: '["vendor-patterns", slug]', kind: 'react-query', key: '["vendor-patterns", slug]', producerCount: 2, consumerCount: 2})`,
  // Clean slot: single SWR hook, no conflict
  `CREATE (ss:StateSlot {id: 'StateSlot:swr:vendor-stats-slug', name: '["vendor-stats", slug]', kind: 'swr', key: '["vendor-stats", slug]', producerCount: 1, consumerCount: 1})`,
