...
export const A11Y_SEED_DATA = [
  ...
  `CREATE (s:A11ySignal {id: 'A11ySignal:components/Hero.tsx:3:img-alt', name: 'img-alt', filePath: 'components/Hero.tsx', startLine: 3, criterion: '1.1.1', signalStatus: 'violation', severity: 'critical', element: 'img', complianceTag: 'eu-required'})`,

  // Violation: input without label (criterion 1.3.1)
  `CREATE (s:A11ySignal {id: 'A11ySignal:components/LoginForm.tsx:5:input-label', name: 'input-label', filePath: 'components/LoginForm.tsx', startLine: 5, criterion: '1.3.1', signalStatus: 'violation', severity: 'serious', element: 'input', complianceTag: 'eu-required'})`,

  // Warning: button without explicit keyboard handler (criterion 2.1.1)
  `CREATE (s:A11ySignal {id: 'A11ySignal:components/LoginForm.tsx:10:keyboard', name: 'keyboard', filePath: 'components/LoginForm.tsx', startLine: 10, criterion: '2.1.1', signalStatus: 'warning', severity: 'moderate', element: 'div[onClick]', complianceTag: 'eu-required'})`,

  // Pass: img with proper alt (criterion 1.1.1)
  `CREATE (s:A11ySignal {id: 'A11ySignal:components/AccessibleCard.tsx:4:img-alt', name: 'img-alt', filePath: 'components/AccessibleCard.tsx', startLine: 4, criterion: '1.1.1', signalStatus: 'pass', severity: 'critical', element: 'img', complianceTag: 'eu-required'})`,

  // Pass: proper landmarks (criterion 1.3.1)
  `CREATE (s:A11ySignal {id: 'A11ySignal:pages/home.tsx:2:landmarks', name: 'landmarks', filePath: 'pages/home.tsx', startLine: 2, criterion: '1.3.1', signalStatus: 'pass', severity: 'serious', element: 'main', complianceTag: 'eu-required'})`,

  // Violation: missing page title (criterion 2.4.2)
  `CREATE (s:A11ySignal {id: 'A11ySignal:pages/home.tsx:1:page-titled', name: 'page-titled', filePath: 'pages/home.tsx', startLine: 1, criterion: '2.4.2', signalStatus: 'violation', severity: 'serious', element: 'html', complianceTag: 'eu-required'})`,
