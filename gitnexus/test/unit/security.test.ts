...
describe('VALID_RELATION_TYPES', () => {
  it('contains all expected relation types', () => {
    ...
    for (const t of ['CALLS', 'IMPORTS', 'EXTENDS', 'IMPLEMENTS', 'HAS_METHOD', 'HAS_PROPERTY', 'OVERRIDES', 'ACCESSES', 'HANDLES_ROUTE', 'FETCHES', 'HANDLES_TOOL', 'ENTRY_POINT_OF', 'WRAPS', 'HAS_A11Y_SIGNAL']) {
