...
describe('GITNEXUS_TOOLS', () => {
  it('exports all tools (7 base + 3 route/tool/shape + 1 api_impact + 1 webhook_map + 1 dead_code + 1 data_flow + 1 wcag_audit)', () => {
  ...
  it('contains all expected tool names', () => {
    ...
    expect(names).toEqual(
      expect.arrayContaining([
        ...
        'detect_changes', 'rename', 'impact', 'api_impact', 'dead_code', 'data_flow', 'wcag_audit',
      ])
    );
  });
