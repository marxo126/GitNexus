...
export class LocalBackend {
  ...
  private async sourceSinkScan(repo: RepoHandle, params: {
    ...
    // Use label-specific MATCH + UNION to avoid labels(n)[0] empty-string issue.
    ...
    // Step 3: Tag source-adjacent and sink-adjacent functions, and build name map in one pass
    ...
    // Step 6: Format results (nodeNameMap was built in step 3)
